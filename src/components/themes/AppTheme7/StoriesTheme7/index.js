...
import Story from 'components/themes/AppTheme7/StoryTheme7'
...
const StoriesTheme7 = ({ data, profile, isSticky, scrollPosition }) => {
...
StoriesTheme7.propTypes = {
  data: PropTypes.arrayOf(PropTypes.shape({}))
};

StoriesTheme7.defaultProps = {
  data: []
};

export default StoriesTheme7; 
